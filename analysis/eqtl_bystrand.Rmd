...
```{r}
same_18486 = same_18486 %>% mutate(same_18486n =s_18486/mapreads_18486)
same_18505= same_18505 %>% mutate(same_18505n =s_18505/mapreads_18505)
same_18508=same_18508 %>% mutate(same_18508n =s_18508/mapreads_18508)
same_19128=same_19128 %>% mutate(same_19128n =s_19128/mapreads_19128)
same_19141=same_19141 %>% mutate(same_19141n =s_19141/mapreads_19141)
same_19193 = same_19193%>% mutate(same_19193n =s_19193/mapreads_19193)
same_19239 =same_19239%>% mutate(same_19239n =s_19239/mapreads_19239)
same_19257 =same_19257%>% mutate(same_19257n =s_19257/mapreads_19257)
```
...
```{r}
opp_18486 = opp_18486 %>% mutate(opp_18486n =o_18486/mapreads_18486)
opp_18505= opp_18505 %>% mutate(opp_18505n =o_18505/mapreads_18505)
opp_18508=opp_18508 %>% mutate(opp_18508n =o_18508/mapreads_18508)
opp_19128=opp_19128 %>% mutate(opp_19128n =o_19128/mapreads_19128)
opp_19141=opp_19141 %>% mutate(opp_19141n =o_19141/mapreads_19141)
opp_19193 = opp_19193%>% mutate(opp_19193n =o_19193/mapreads_19193)
opp_19239 =opp_19239%>% mutate(opp_19239n =o_19239/mapreads_19239)
opp_19257 =opp_19257%>% mutate(opp_19257n =o_19257/mapreads_19257)
```
...
by_geno_exp=function(rsID){
  ...
  x=as.data.frame(x)
  x$V1=as.factor(x$V1)
  plot=ggplot(x, aes(y=log10(V2), x=V1)) + geom_boxplot() + geom_jitter(col="red") + ggtitle(paste(rsID,":eqtl beta=", beta)) + xlab("Genotype") + ylab("log 10 normalized count")
  return(plot)
}
```

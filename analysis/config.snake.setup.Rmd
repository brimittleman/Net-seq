...
rule all:
    input:
       ...
       expand(dir_bam + "{samples}-sort.bam", samples= samples),
       expand(dir_bam + "{samples}-sort.bam.bai", samples=samples)

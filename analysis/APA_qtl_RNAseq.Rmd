...
list1=pas_gene_cov_norm_t[1,]
list2= geno_apa_rs7144811_apa[1,]
usage1= rbind(list1,list2)

longform_usage1 <- data.frame(apa_score=as.character(usage1[1,]), genotype=as.character(usage1[2,]), individual=as.vector(colnames(usage1)))



rs7144811_plot_usage = ggplot(data = longform_usage1) + 

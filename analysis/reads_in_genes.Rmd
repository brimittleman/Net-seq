...
ggplot(standard_counts, aes(x=-log(st_18486))) + geom_density()
ggplot(standard_counts, aes(x=-log(st_18508_dep))) + geom_density()
ggplot(standard_counts, aes(x=-log(st_18508_nondep))) + geom_density()
ggplot(standard_counts, aes(x=-log(st_19238))) + geom_density()
ggplot(standard_counts, aes(x=-log(st_mayer))) + geom_density()
